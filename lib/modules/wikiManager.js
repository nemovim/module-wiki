...
export default class WikiManager {
    ...
    static async updateDocByFullTitle(fullTitle, user, newInfo) {
        ...
        } else if (newInfo.authorityObj !== undefined && AuthorityManager.canUpdateAuthority(user.authority)) {
    ...
    static async compareDocByFullTitle(fullTitle, user, oldRev, newRev) {
        ...
        return {
            diff: Diff.diffWords(oldDoc.markup, newDoc.markup),
            oldDoc,
            newDoc,
        };
    }
