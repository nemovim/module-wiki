...
class WikiDoc {
    ...
    getCategoryContent() {
        ...
        let categoryContent = '';
        let docCategorizedContent = this.getCategorizedContent(this.getCategorizedMap(this.categorized.get('doc')));
        let categoryCategorizedContent = this.getCategorizedContent(this.getCategorizedMap(this.categorized.get('category')));
    ...
    getCategorizedContent(categorizedMap) {
        if (categorizedMap.size !== 0) {
           return WikiDoc.chosungArr.reduce((prev, chosung) => {
