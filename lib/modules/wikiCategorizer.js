...
class WikiCategorizer {
    ...
    constructor(_categorizedTitle, _uncategorizedTitle) {
        this.#categorizedMap = new Map();
        this.#categoryMap = new Map();
        this.categorizedTitle = _categorizedTitle;
        this.uncategorizedTitle = _uncategorizedTitle;
    }
    ...
    addDocToExistCategory(docId, categoryId) {
        let updateCategorizedArr = this.#categorizedMap.get(categoryId) || []; // This OR is only for uncategorized category.
        updateCategorizedArr.push(docId);
